...
# MOWN
# Go char by char and increment counter by width
# if counter > 100 increment line_count
class Solution(object):
    def numberOfLines(self, widths, S):
        ...
        :rtype: List[int]
        """
        line_count, counter = 1, 0
        for char in S:
            counter += widths[ord(char.lower()) - ord('a')]
            if counter > 100:
                line_count += 1
                counter = widths[ord(char.lower()) - ord('a')]

        return [line_count, counter]